//
//  YKWeiboDiscoverViewController.swift
//  iStudySwift
//
...
let kYKWeiboDiscoverURLString = "yk://istudydemo/weibo/discover"

class YKWeiboDiscoverViewController: YKWeiboBaseTableViewController {
    ...
    static func portalLoad()
    {
        YKPortal.registerPortalWithHandler(handler: { (transferURL:NSURL, transferType:YKTransferType, sourceViewController:UIViewController) -> UIViewController? in
            ...
            if transferURL.hasSameTrunkWithURL(URL: NSURL(string:kYKWeiboDiscoverURLString)!) {
                let viewController = YKWeiboDiscoverViewController()
        ...
        }, prefixURL: NSURL(string: kYKWeiboDiscoverURLString)!)
    }
